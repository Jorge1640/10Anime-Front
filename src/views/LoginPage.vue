  ...
  <div class="login-page">
    <div class="login-container">
      ...
      <div class="social-icons">
        <button aria-label="Log in with Google" class="icon" @click="login">
...
export default {
  ...
  methods: {
    // handleLogin() {
    //   // Lógica de login
    //   console.log('Email:', this.email); // Cambiado de Username a Email
...
.login-container {
  width: 400px; /* Ancho fijo del contenedor de login */
  padding: 40px;
  background-color: rgba(28, 28, 30, 0.8); /* Fondo semi-transparente */
  border-radius: 10px;
  color: white;
}
</style>