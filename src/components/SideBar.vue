<template>
  <div class="app-container" :class="{ 'sidebar-open': !isSidebarClosed }">
          ...
          <ul class="menu-links">
            ...
            <li class="nav-link">
              <a href="#">
                ...
                <span class="text nav-text">Types</span>
              </a>
            </li>
            ...
            <li class="nav-link">
              <a href="#">
                ...
                <span class="text nav-text">Added</span>
              </a>
            </li>
            ...
            <li class="nav-link">
              <a href="#">
                ...
                <span class="text nav-text">Upgoing</span>
              </a>
            </li>
...
export default {
  ...
  mounted() {
    ...
    searchBtn.addEventListener("click", this.openSidebar);
  }
};
</script>
...
.carousel {
  flex: 1; /* Asegura que el carrusel ocupe todo el espacio disponible */
  margin-right: 0; /* Elimina el margen derecho */
}

.filter-section {
  margin-left: auto; /* Desplaza la sección de filtro hacia la derecha */
